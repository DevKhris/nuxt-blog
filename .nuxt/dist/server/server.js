...
/******/ 			var chunk = require("./" + ({"1":"pages/index","2":"pages/posts/_id"}[chunkId]||chunkId) + ".js");
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".container{transition:all .5s ease-in-out}.page-enter-active,.page-leave-active{transition:opacity .5s}.page-enter,.page-leave-active{opacity:0}.page-enter-active,.page-leave{transition:all .5s ease-in-out}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
const _685691ee = () => interopDefault(__webpack_require__.e(/* import() | pages/posts/_id */ 2).then(__webpack_require__.bind(null, 25)));

const _18aa907b = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 1).then(__webpack_require__.bind(null, 24)));
...
var bulma = __webpack_require__(17);
